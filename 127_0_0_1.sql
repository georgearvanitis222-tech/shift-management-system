...
-- Χρόνος δημιουργίας: 05 Ιουν 2026 στις 16:38:59
...
('root', '[{\"db\":\"shift_management\",\"table\":\"shifts\"},{\"db\":\"shift_management\",\"table\":\"employees\"}]');
...
('root', '2026-06-05 14:38:22', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"el\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Βάση δεδομένων: `shift_management`
--
CREATE DATABASE IF NOT EXISTS `shift_management` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
--
-- Δομή πίνακα για τον πίνακα `shifts`
--
...
--
-- AUTO_INCREMENT για πίνακα `shifts`
--
ALTER TABLE `shifts`
